#! /bin/bash
 ...
 ./latest_graalvm_home/bin/java -XX:+UseJVMCICompiler -XX:+UseJVMCINativeLibrary \
  ...
  -Djdk.graal.LogFile=VisualVMAOT.txt -Djdk.graal.PrintCompilation=true  \
  ...
  -agentpath:/home/hburchell/visualvm_218/visualvm/lib/deployed/jdk16/linux-amd64/libprofilerinterface.so=/home/hburchell/visualvm_218/visualvm/lib,51403 \
