...
./latest_graalvm_home/bin/java \
  ...
  -Djdk.graal.TrackNodeSourcePosition=true -agentpath:/home/hb478/repos/are-we-fast-yet/Async/build/libasyncProfiler.so=start,event=cpu,interval=10,file=PureLirAssign2.txt  \
