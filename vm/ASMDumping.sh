...
./latest_graalvm_home/bin/java \
 -Djdk.graal.EnableGTSlowDown=false \
 -Djdk.graal.LIRGTSlowDown=false \
 -Djdk.graal.LIRBlockSlowdownFileName=BlockSlowdown1.json \
 -Djdk.graal.ASMGTSlowDown=false \
 -XX:+UnlockExperimentalVMOptions \
 -XX:+UnlockDiagnosticVMOptions \
 -XX:+EnableJVMCI \
 -Djdk.graal.PrintLIRWithAssembly=true \
 -Djdk.graal.Dump=CodeGen \
 -Djdk.graal.PrintBackendCFG=false \
 -Djdk.graal.LogFile=AssemblyOut.txt \
 -XX:+UseJVMCICompiler -XX:-UseJVMCINativeLibrary \
 -XX:-TieredCompilation \
 -XX:-BackgroundCompilation \
 '-XX:CompileCommand=dontinline,*::*' \
 -Djdk.graal.TrivialInliningSize=0 \
 -XX:+PrintAssembly \
 -XX:+PrintNMethods \
