...
# /home/hburchell/JDKS/graalvm-jdk-22+36.1
 mx --java-home \
 /home/hburchell/Downloads/labsjdk-ce-21.0.2-jvmci-23.1-b33 \
 vm -Djdk.graal.EnableGTSlowDown=false -Djdk.graal.LIRGTSlowDown=true -Djdk.graal.CollectLIRCostInformation=false -Djdk.graal.LIRGTSlowDownDebugMode=false -Djdk.graal.LIRCostInformationFile=x.json \
