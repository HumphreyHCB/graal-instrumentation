 ...
 */
public final class BuboVoidStamp extends Stamp {

    private BuboVoidStamp() {
    }
    ...
    public Stamp improveWith(Stamp other) {
        assert other instanceof BuboVoidStamp;
        return this;
    }
    ...
    public boolean isCompatible(Stamp stamp) {
        return stamp instanceof BuboVoidStamp;
    }
    ...
    private static final BuboVoidStamp instance = new BuboVoidStamp();

    static BuboVoidStamp getInstance() {
        return instance;
    }
}
