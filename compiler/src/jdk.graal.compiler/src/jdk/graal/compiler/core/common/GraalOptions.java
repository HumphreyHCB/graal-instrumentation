...
public final class GraalOptions {
    ...
    @Option(help = "", type = OptionType.Debug)
    public static final OptionKey<Boolean> GTDebugInfoLog= new OptionKey<Boolean>(false);

    @Option(help = "", type = OptionType.Debug)
    public static final OptionKey<Boolean> GTChangeDebugInfo = new OptionKey<Boolean>(false);
}
