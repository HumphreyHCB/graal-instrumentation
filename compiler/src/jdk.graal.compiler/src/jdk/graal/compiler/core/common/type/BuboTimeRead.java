 ...
 */
public final class BuboTimeRead extends Stamp {

    private BuboTimeRead() {
    }
    ...
    private static final BuboTimeRead instance = new BuboTimeRead();

    static BuboTimeRead getInstance() {
        return instance;
    }
}
