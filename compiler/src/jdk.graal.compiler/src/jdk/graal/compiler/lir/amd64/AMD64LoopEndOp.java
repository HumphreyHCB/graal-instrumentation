 ...
 */
@Opcode("BUBO_Loop_End")
public final class AMD64LoopEndOp extends AMD64LIRInstruction {
    public static final LIRInstructionClass<AMD64LoopEndOp> TYPE = LIRInstructionClass.create(AMD64LoopEndOp.class);
