...
mx -d --java-home \
 /home/hburchell/Downloads/labsjdk-ce-21.0.2-jvmci-23.1-b33 \
 vm -Djdk.graal.GTMarkBasicBlocks=false -Djdk.graal.LIRGTSlowDown=true -Djdk.graal.LIRBlockSlowdownFileName=/home/hb478/repos/GTSlowdownSchedular/Data/2025_01_07_23_59_19_SlowDown_Data/_Iter215_Towers::moveDisks.json  \
 -XX:+UnlockExperimentalVMOptions -XX:+EnableJVMCI \
  -XX:+UseJVMCICompiler \
  -cp /home/hburchell/Repos/graal-dev/graal-instrumentation/compiler:benchmarks.jar \
  Harness Towers 5000 2500 
